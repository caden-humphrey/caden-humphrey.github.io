// ==UserScript==
// @name         Large Local Salesforce Automations
...
// @grant        none
// @updateURL    https://caden-humphrey.github.io/large-local-salesforce-automations.js
// @downloadURL  https://caden-humphrey.github.io/large-local-salesforce-automations.js
// ==/UserScript==
(function () {
    if (window.top === window.self) {
        ...
        window.insertCustomUI = function () {
            ...
            style.textContent = `
                ...
                button.caden.automationButton.opp.start {
                    ...
                    border-top-right-radius: 0px !important;
                    border-bottom-right-radius: 0px !important;
                    border-right: 1.11111px solid rgb(116, 116, 116) !important;
                }
        ...
        window.testUIvariables = function () {
            return {
                ...
                $200Button: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('button[id="$200Package"],button[id="$299Package"]'),
            };
        };
        ...
        window.moveFields = function () {
            ...
            if (testUI.holdoutSegmentationName !== null) { testUI.column4.prepend(testUI.holdoutSegmentationName); }
            if (testUI.holdoutV1 !== null) { testUI.column4.prepend(testUI.holdoutV1); }
        ...
        window.insertOppAutomations = function () {
            const $299Button = document.createElement('div');
            $299Button.className = 'caden automationButtonContainer opp start';
            $299Button.innerHTML = `
            <button id="$299Package" class="caden automationButton opp start $299Package">
                $299 Package
            </button>
            `;
            const $399Button = document.createElement('div');
            $399Button.className = 'caden automationButtonContainer opp middle';
            $399Button.innerHTML = `
            <button id="$399Package" class="caden automationButton opp middle $399Package">
                $399 Package
            </button>
            `;
            const $499Button = document.createElement('div');
            $499Button.className = 'caden automationButtonContainer opp middle';
            $499Button.innerHTML = `
            <button id="$499Package" class="caden automationButton opp middle $499Package">
                $499 Package
            </button>
            `;
            const $300Button = document.createElement('div');
            $300Button.className = 'caden automationButtonContainer opp end';
            $300Button.innerHTML = `
            <button id="$300Package" class="caden automationButton opp end $300Package">
                $300 Package
            </button>
            `;
            $299Button.addEventListener('click', () => {
                window.fillPackage($299Package);
            });
            $399Button.addEventListener('click', () => {
                window.fillPackage($399Package);
            });
            $499Button.addEventListener('click', () => {
                window.fillPackage($499Package);
            });
            ...
            testUI.automationInsertSlot.insertBefore($299Button, testUI.automationInsertBefore);
            testUI.automationInsertSlot.insertBefore($399Button, testUI.automationInsertBefore);
            testUI.automationInsertSlot.insertBefore($499Button, testUI.automationInsertBefore);
        ...
        window.convertContact = function () {
            ...
            var leadTypeValue = 'Large Local Sales';
        ...
        window.$299Package = function () {
            window.paidAmount = '299';
            window.promoCredit = '0';
            window.none = '--None--';
            window.typeValue = 'Net New';
            window.numEmployeesValue = '10+';
            window.numLocationsValue = '1-4';
            window.franchiseValue = 'No';
            window.packageValue = 'MASA';
            window.packageLevelvalue = 'Pay $299';
            window.leadTypeValue = 'Large Local Sales';
            window.leadSourceValue = 'Recent Signup';
            window.batchValue = 'none';
        };
        window.$399Package = function () {
            window.paidAmount = '399';
            window.promoCredit = '0';
            window.none = '--None--';
            window.typeValue = 'Net New';
            window.numEmployeesValue = '10+';
            ...
            window.franchiseValue = 'No';
            window.packageValue = 'MASA';
            window.packageLevelvalue = 'Pay $399';
            window.leadTypeValue = 'Large Local Sales';
            window.leadSourceValue = 'Recent Signup';
            window.batchValue = 'none';
        };
        window.$499Package = function () {
            window.paidAmount = '499';
            window.promoCredit = '0';
            window.none = '--None--';
            window.typeValue = 'Net New';
            window.numEmployeesValue = '10+';
            ...
            window.franchiseValue = 'No';
            window.packageValue = 'MASA';
            window.packageLevelvalue = 'Pay $400';
            window.leadTypeValue = 'Large Local Sales';
            window.leadSourceValue = 'Recent Signup';
            window.batchValue = 'none';
        };
