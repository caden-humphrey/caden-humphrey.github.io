console.log('Hello from Caden -- Salesforce');
(function () {
    if (window.top === window.self) {
        ...
        window.testUIvariables = function () {
            return {
                ...
                salesActivationDate: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('flexipage-field[data-field-id="RecordSalesActivationDate_cField"]'),
                maxActivationDate: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('flexipage-field[data-field-id="RecordMaxActivationDate_cField"]'),

                headerSlot: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('div[class="secondaryFields"] slot'),
                occupationHeader: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelectorAll('div[class="secondaryFields"] slot records-highlights-details-item')[3],
                firstServiceCreateTimeHeader: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelectorAll('div[class="secondaryFields"] slot records-highlights-details-item')[4],

                createdDateOutputSlot: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('flexipage-field[data-field-id="RecordCreatedByIdField"] records-modstamp[slot="output"]'),
                createdDateLightningFormattedTextElement: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelector('flexipage-field[data-field-id="RecordCreatedByIdField"] records-modstamp[slot="output"] lightning-formatted-text'),

                headerSecondFlexipageComponent: document.querySelector('[class="windowViewMode-maximized active lafPageHost"]')?.querySelectorAll('slot[name="header"] flexipage-component2')[1],
            };
        };
        ...
        window.contactConditionalFormatting = function () {
            window.wait(() => testUI.salesActivationDate?.innerText !== undefined && testUI.maxActivationDate?.innerText !== undefined && testUI.decile?.innerText !== undefined && testUI.numberOfEmployees?.innerText !== undefined && testUI.createdDate?.innerText !== undefined).then(() => {
                (function highlightSalesActivationDate() {
                    const targetComponent = testUI.salesActivationDate;
                    const targetText = targetComponent?.innerText.split('\n')[2];
                ...
                (function highlightMaxActivationDate() {
                    const targetComponent = testUI.maxActivationDate;
                    const targetText = targetComponent?.innerText.split('\n')[1];
                ...
                (function highlightDecile() {
                    const targetComponent = testUI.decile;
                    const targetText = targetComponent?.innerText.split('\n')[1].trim();

                    if (targetText === 'Decile 1' || targetText === 'Decile 2' || targetText === 'Decile 3') {
                        targetComponent.style.backgroundColor = 'rgba(99, 248, 99, 0.426)';
                    } else if (targetText === 'Decile 8' || targetText === 'Decile 9' || targetText === 'Decile 10') {
                        targetComponent.style.backgroundColor = 'rgba(255, 0, 0, 0.168)';
                    } else {
                        targetComponent.style.backgroundColor = '';
                    }
                ...
                (function highlightEmployees() {
                    const targetComponent = testUI.numberOfEmployees;
                    const targetText = targetComponent?.innerText.split('\n')[1].trim();

                    if (targetText === '2-3 people' || targetText === '4-9 people') {
                        targetComponent.style.backgroundColor = 'rgba(99, 248, 99, 0.426)';
                    } else if (targetText.includes('10+')) {
                        targetComponent.style.backgroundColor = 'rgba(255, 0, 0, 0.168)';
                    } else {
                        targetComponent.style.backgroundColor = '';
                    }
                ...
                (function highlightCreatedDate() {
                    const createdDateElement = testUI.createdDate;
                    const dateValue = new Date(createdDateElement.innerText.split(',')[1].trim());
                    ...
                    if (dateValue.getTime() === today.getTime() || dateValue.getTime() === yesterday.getTime()) {
                        createdDateElement.style.backgroundColor = 'rgba(99, 248, 99, 0.426)';
                    } else {
                        createdDateElement.style.backgroundColor = '';
                    }
                })();
            });
        };
        window.moveFields = function () {
            testUI.headerSlot.insertBefore(testUI.firstServiceCreateTimeHeader, testUI.occupationHeader);
            testUI.column1.prepend(testUI.preferredPhone);
            testUI.column1.prepend(testUI.phone);
            ...
            testUI.createdDateOutputSlot.insertBefore(newBreak, testUI.createdDateLightningFormattedTextElement);
            window.wait(() => testUI.headerSecondFlexipageComponent?.innerText !== undefined).then(() => {
                if (testUI.headerSecondFlexipageComponent?.innerText == "") {
                    console.log('CHUMPS -- header IS EMPTY');
                    // insert style attribute to hide the header
                    testUI.headerSecondFlexipageComponent.style.cssText = 'display: none !important';
                } else {
                    console.log('CHUMPS -- header IS NOT empty' + testUI.headerSecondFlexipageComponent?.innerText);
                }
            });
        ...
        window.formatCustomContact = function () {
            ...
            wait(() => testUiElements.every(element => testUI[element]?.innerText !== undefined)).then(() => {
                if (!testUI.secondFlexipageComponenet?.innerText.includes('Pro Activation Detail')) {
                    window.moveFields();
                    window.contactConditionalFormatting();
                }
